...
from core.utils.file import pickle_to_file
...
class TranslationRequestDService():
    ...
    async def create_file_translation_request(self, command: CreateFileTranslationRequestCommand):
        ...
        source_file_path = gen_source_file_file_path(new_task_result_entity.props.task_id.value)

        saved_file_path =  pickle_to_file(source_file_path, command.source_file)
