...
from infrastructure.configs.speech_recognition_task import SpeechRecognitionTask_ConvertingResultFileSchemaV1, SpeechRecognitionTask_NotYetConvertedResultFileSchemaV1
...
async def read_task_result(
    ...
    for task_id in intersection_tasks_id:
        ...
        try: 
            ...
            if data['status'] == SpeechRecognitionTask_NotYetConvertedResultFileSchemaV1(
