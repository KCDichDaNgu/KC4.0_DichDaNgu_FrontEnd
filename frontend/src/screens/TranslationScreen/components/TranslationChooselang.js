	...
	return (
		<div style={{ borderBottom: '1px solid #ccc', display: 'flex', flexDirection: 'row', justifyContent: 'space-between' }} >
			...
			<div style={{ flex: 1, display: 'flex', overflow: 'auto', whiteSpace: 'nowrap' }}>
				...
				>
					{/* {translateType === TRANSLATE_TYPE.plainText ?
						...
						/> : null} */}
					<Tab label={t('Translate.listLanguage.trung')} value={'zh'} disabled={isDisableTab()} style={{ fontWeight: 'bold' }} />
					<Tab label={t('Translate.listLanguage.anh')} value={'en'} disabled={isDisableTab()} style={{ fontWeight: 'bold' }} />
				</Tabs>
			</div>
			...
			<div style={{ flex: 1, display: 'flex', overflow: 'auto', whiteSpace: 'nowrap' }}>
				...
				>
					<Tab label={t('Translate.listLanguage.viet')} value={'vi'} disabled={isDisableTab()} style={{ fontWeight: 'bold' }} />
				</Tabs>
			</div>
		</div>
	);
